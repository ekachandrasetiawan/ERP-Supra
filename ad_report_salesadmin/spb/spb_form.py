...
class spb_form(report_sxw.rml_parse):
    
    def __init__(self, cr, uid, name, context):
        super(spb_form, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.spb.form', 'mrp.production', 'ad_report_salesadmin/spb/spb_form.mako', parser=spb_form,header=False)
