{
    ...
    "version": "1.0",
    "depends": ["purchase","ad_perintah_kerja","ad_delivery_note","account","ad_discount"],
    ...
    "init_xml": [], 
    'update_xml': ["stock_picking.xml","po.xml","special_work_order.xml","special_dn.xml","account_invoice_line.xml","account_bank_statement.xml"],
    'demo_xml': [],
    'installable': True,
    'active': False,
}