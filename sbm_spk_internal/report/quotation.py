...
# report_sxw.report_sxw('report.quotation.report', 'sale.order', 'sbm_spk_internal/report/quotation.mako', parser=quotation_form,header=False)
...
# report_sxw.report_sxw('report.spk.continue', 'perintah.kerja', 'addons/sbm_spk_internal/report/spk_continue.rml', parser=ReportStatus, header=False)
