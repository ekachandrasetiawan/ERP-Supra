...
report_sxw.report_sxw('report.faktur.pajak.valas.form', 'account.invoice', 'addons/ad_report_salesadmin/fp/faktur_pajak_valas.mako', parser=faktur,header=False)
report_sxw.report_sxw('report.faktur.pajak.form', 'account.invoice', 'addons/ad_report_salesadmin/fp/faktur_pajak.mako', parser=faktur,header=False)      
